...
class Node:
  ...
  def generate_decoder(self, depth):
    ...
    if self.val:
      return space + "return {{'{0!s}', {1:d}}};".format(str(self.val), depth)
  ...
  def generate_encoder(self, stack):
    ...
    if self.val:
      ...
      sb += "bits = {0:d}; num_bits = {1:d}; ".format(numeric_val, len(stack))
      sb += "return; }\n"
      return sb
    sb = ""
...
print "const unsigned LongestEncodingLength = {0:d};".format((nodes[0].getMaxEncodingLength()))
